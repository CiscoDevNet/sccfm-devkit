...
class TransactionService:
    ...
    def wait_for_transaction_to_finish(
        ...
        cdo_transaction: CdoTransaction = self.transactions_api.get_transaction(
        ...
        while cdo_transaction.cdo_transaction_status not in [
            ...
            cdo_transaction = self.transactions_api.get_transaction(transaction_uid=transaction_uid)
