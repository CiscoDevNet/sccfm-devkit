...
from cisco_sccfm_cli.commands.objects.network.create import CreateNetworkObjectCommand
from cisco_sccfm_cli.commands.objects.network.delete import DeleteNetworkObjectCommand
from cisco_sccfm_cli.commands.objects.network.list import ListNetworkObjectCommand
from cisco_sccfm_cli.commands.objects.network.update import UpdateNetworkObjectCommand
