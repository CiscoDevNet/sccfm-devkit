...
from cisco_sccfm_cli.commands.inventory.devices.ftd.upgrade.compatible_versions import (
    FtdUpgradeCompatibleVersionsCommand,
)
from cisco_sccfm_cli.commands.inventory.devices.ftd.upgrade.trigger import (
