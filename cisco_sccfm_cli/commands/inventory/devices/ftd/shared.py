...
from cisco_sccfm_cli.commands.inventory.options import limit_option, offset_option, query_option
from cisco_sccfm_cli.utils import print_json
from cisco_sccfm_core import FTD_DEVICE_TYPE_FILTER, InventoryService
...
def ftd_check_option() -> click.Option:
    """Reusable --check flag for FTD mutating commands."""
    return click.Option(
        ["--check"],
        is_flag=True,
        default=False,
...
class FtdDeviceTargetCommand(BaseCommand):
