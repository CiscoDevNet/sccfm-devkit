...
from cisco_sccfm_cli.commands.inventory.devices.asa.user.change_password import (
    AsaChangePasswordCommand,
)


class AsaUserCommand(BaseCommand):
    def __init__(self, console: Console) -> None:
        super().__init__(console)
        self._subcommands: List[BaseCommand] = [
            AsaChangePasswordCommand(console),
        ]
    ...
    def help_text(self) -> str:
        return "ASA local user operations."
