...
from cisco_sccfm_cli.commands.inventory.devices.asa.upgrade.compatible_versions import (
    AsaUpgradeCompatibleVersionsCommand,
)
from cisco_sccfm_cli.commands.inventory.devices.asa.upgrade.trigger import (
