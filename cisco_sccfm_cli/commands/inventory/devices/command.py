...
from cisco_sccfm_cli.commands.inventory.devices.asa import AsaCommand
from cisco_sccfm_cli.commands.inventory.devices.cdfmc_managed_ftd import CdfmcManagedFtdCommand
from cisco_sccfm_cli.commands.inventory.devices.ftd import FtdCommand
from cisco_sccfm_cli.commands.inventory.devices.list import DevicesListCommand
