...
"""Tests for the ``cisco_sccfm_cli inventory devices asa upgrade trigger`` command."""
...
from cisco_sccfm_core.services.inventory import AsaUpgradeService, AsaUpgradeVersionService
