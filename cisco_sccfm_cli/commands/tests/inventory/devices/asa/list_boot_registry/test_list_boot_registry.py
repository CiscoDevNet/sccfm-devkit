...
"""Tests for cisco_sccfm_cli inventory devices asa list-boot-registry command."""
...
from cisco_sccfm_core.services import AsaBootRegistryService, InventoryService
