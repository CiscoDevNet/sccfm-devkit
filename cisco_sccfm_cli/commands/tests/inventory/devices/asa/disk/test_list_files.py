...
from cisco_sccfm_core.models.asa_disk_file import AsaDiskFile, AsaDiskFileType
from cisco_sccfm_core.services import AsaDiskFileService, InventoryService
