...
_ASA_DEVICE_TYPE = EntityType.ASA


class AsaListCommand(BaseCommand):
    @property
    def name(self) -> str:
        return "list"
    ...
    @with_spinner("Fetching ASA devices from SCC Firewall Manager...")
    def handle(self, ctx: click.Context, **kwargs: Any) -> None:
        ...
        device_type_filter = f"deviceType:{_ASA_DEVICE_TYPE.value}"
