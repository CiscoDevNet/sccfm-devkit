...
def test_sccfm_cli_skill_should_be_available_at_claude_discovery_path() -> None:
    assert SKILL_PATH.is_file()
    assert CLAUDE_SKILL_PATH.is_file()
    assert CLAUDE_SKILL_PATH.resolve() == SKILL_PATH.resolve()


def test_sccfm_cli_skill_should_be_available_at_codex_discovery_path() -> None:
    assert CODEX_SKILL_DIR.is_symlink()
    assert CODEX_SKILL_PATH.is_file()
    assert CODEX_SKILL_PATH.resolve() == SKILL_PATH.resolve()


def test_sccfm_cli_skill_frontmatter_should_be_claude_compatible() -> None:
...
def test_sccfm_cli_skill_should_cover_schema_driven_operation() -> None:
...
def test_sccfm_cli_skill_should_reference_fields_emitted_by_schema(
...
def test_sccfm_cli_skill_should_not_hardcode_operational_command_examples() -> None:
    _metadata, body = _parse_skill()
