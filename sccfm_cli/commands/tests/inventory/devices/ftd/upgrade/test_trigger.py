"""Tests for the ``sccfm_cli inventory devices ftd upgrade trigger`` command."""
...
from sccfm_core.services.inventory import FtdUpgradeService, FtdUpgradeVersionService
