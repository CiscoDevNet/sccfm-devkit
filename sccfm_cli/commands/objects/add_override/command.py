...
class AddOverrideObjectCommand(BaseCommand):
    ...
    def help_text(self) -> str:
        return "Add a device-specific override to an object."
    ...
    def build_params(self) -> Sequence[click.Parameter]:
        return [
            ...
            click.Option(
                ...
                required=True,
                type=str,
                help="UID of the target device for the override.",
            ),
            click.Option(
                ["--override-value"],
                required=True,
                type=str,
                help="Literal override value (IP address, CIDR, range, or URL).",
            ),
            format_option(),
            config_path_option(),
        ]

    @with_spinner("Adding override...")
    def handle(self, ctx: click.Context, **kwargs: Any) -> None:
        ...
        try:
            response: ObjectOverrideResponse = service.add_override(
                uid=uid,
                target_id=target_id,
    ...
    def _render_response(
        ...
        self.console.print("[green]✓[/green] Override added successfully")
