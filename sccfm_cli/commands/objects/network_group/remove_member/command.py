...
class RemoveNetworkGroupMemberCommand(BaseCommand):
    ...
    def help_text(self) -> str:
        return "Remove referenced network-object members from a network group."

    def build_params(self) -> Sequence[click.Parameter]:
        return group_member_mutation_params()

    @with_spinner("Removing network group members...")
    ...
    def _render_response(
        ...
        if result.changed:
            self.console.print("[green]✓[/green] Network group members removed")
        else:
            self.console.print(
                "[yellow]![/yellow] Network group already excludes all requested members"
            )
