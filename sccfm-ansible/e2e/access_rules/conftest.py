...
"""Shared fixtures for Ansible e2e access rule integration tests."""
...
ACCESS_RULES_DIR = Path(__file__).resolve().parent
PLAYBOOKS_DIR = ACCESS_RULES_DIR / "playbooks"
EXAMPLES_DIR = ACCESS_RULES_DIR.parent.parent / "examples"
