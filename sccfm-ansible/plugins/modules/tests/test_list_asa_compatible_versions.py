...
import pytest
from plugins.modules import list_asa_compatible_versions  # noqa: E402
...
@pytest.fixture
def sample_group_versions() -> AsaGroupCompatibleVersions:
...
@patch("plugins.modules.list_asa_compatible_versions.Config")
@patch("plugins.modules.list_asa_compatible_versions.AsaUpgradeVersionService")
@patch("plugins.modules.list_asa_compatible_versions.InventoryService")
...
def test_should_return_compatible_versions_with_query(
    ...
    sample_group_versions: AsaGroupCompatibleVersions,
) -> None:
    ...
    assert call_kwargs["compatible_versions"][0]["software_version"] == "9.18.4"
