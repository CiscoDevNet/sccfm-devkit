...
#
# Usage:
#   ./scripts/install_skills.sh                    # install to ~/.claude/skills
#   ./scripts/install_skills.sh /path/to/skills    # install to a custom dir
#   ./scripts/install_skills.sh --uninstall        # remove installed skills
#
