...
1. Navigate to the GitHub Releases page for this project.
2. Download the latest wheel asset named like `sccfm-<version>-py3-none-any.whl`.

## Install with pip

```bash
python3.12 -m pip install /path/to/sccfm-<version>-py3-none-any.whl
```
...
- **zsh**
  ...
  ```bash
  eval "$(_SCCFM_COMPLETE=zsh_source sccfm)"
