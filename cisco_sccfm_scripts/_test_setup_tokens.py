...
def preserve_managed_files() -> Iterator[None]:
    """Restore ignored credential files when tests are invoked through pytest."""
    backup_all()
    try:
        yield
    finally:
...
def test_ansible_vault_available() -> None:
    from cisco_sccfm_scripts.setup_tokens import _verify_ansible_vault
...
def test_vault_pass_detected() -> None:
    from cisco_sccfm_scripts.setup_tokens import _ensure_vault_pass
...
def test_vars_region_updated() -> None:
    from cisco_sccfm_scripts.setup_tokens import _update_vars_region
...
def test_env_file_updates_in_place() -> None:
    ...
    from cisco_sccfm_scripts.setup_tokens import _write_env_file
...
def test_upsert_env_var_replaces_existing() -> None:
    ...
    from cisco_sccfm_scripts.setup_tokens import _upsert_env_var
...
def test_merge_token_adds_new() -> None:
    ...
    from cisco_sccfm_scripts.setup_tokens import _merge_token
...
def test_headless_mode_detection() -> None:
    ...
    from cisco_sccfm_scripts.setup_tokens import main
    ...
    with patch("cisco_sccfm_scripts.setup_tokens._run_headless") as mock_headless:
