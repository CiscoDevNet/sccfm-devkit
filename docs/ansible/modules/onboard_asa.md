...
> MODULE [1mcisco.sccfm.onboard_asa[0m (sccfm-ansible/plugins/modules/onboard_asa.py)
...
[1mOPTIONS[0m (red indicates it is required):
   ...
   [1mconnector_type[0m  Connector type used to communicate with the device.
        choices: [SDC, CDG]
        type: str

   [1mdevice_address[0m  Device address in the form host:port.
        type: str
   ...
   [1mname[0m    Human-readable name for the ASA device.
        type: str

   [1mpassword[0m  Password used to authenticate with the device.
        no_log: true
        type: str
   ...
   [1musername[0m  Username used to authenticate with the device.
        type: str
