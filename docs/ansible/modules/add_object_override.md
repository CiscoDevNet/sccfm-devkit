...
> MODULE [1mcisco.sccfm.add_object_override[0m (sccfm-ansible/plugins/modules/add_object_override.py)
...
[1mOPTIONS[0m (red indicates it is required):
   ...
   [1moverride_value[0m  The literal value for the override. For network
   ...
   [1mtarget_id[0m  UID of the target device for which the override applies.
        type: str

   [1muid[0m     Unique identifier (UID) of the object to add the override
           to.
        type: str
