...
> MODULE [1mcisco.sccfm.create_access_rule[0m (sccfm-ansible/plugins/modules/create_access_rule.py)
...
[1mOPTIONS[0m (red indicates it is required):
   ...
   [1maccess_group_uid[0m  UID of the access group.
        type: str
   ...
   [1mentity_uid[0m  UID of the device or manager.
        type: str

   [1mindex[0m   Position of the rule in the ordered list.
        type: int
