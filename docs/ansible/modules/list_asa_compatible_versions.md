---
layout: page
title: "cisco.sccfm.list_asa_compatible_versions"
---
...
{% raw %}
```text
$ ansible-doc -t module cisco.sccfm.list_asa_compatible_versions

> MODULE cisco.sccfm.list_asa_compatible_versions (sccfm-ansible/plugins/modules/list_asa_compatible_versions.py)

  Queries compatible upgrade versions for one or more ASA devices
...
- common_versions  Software versions compatible with every selected
                    ASA device. Returned for multi-device queries or
