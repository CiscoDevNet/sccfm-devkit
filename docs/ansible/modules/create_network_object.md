...
> MODULE [1mcisco.sccfm.create_network_object[0m (sccfm-ansible/plugins/modules/create_network_object.py)
...
[1mOPTIONS[0m (red indicates it is required):
   ...
   [1mname[0m    Name of the network object.
        type: str
   ...
   [1mvalue[0m   Literal value of the network object. Can be an IP address
