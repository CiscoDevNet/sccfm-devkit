...
> MODULE [1mcisco.sccfm.update_access_rule[0m (sccfm-ansible/plugins/modules/update_access_rule.py)
...
[1mOPTIONS[0m (red indicates it is required):
   ...
   [1muid[0m     Unique identifier (UID) of the access rule to update.
        type: str
