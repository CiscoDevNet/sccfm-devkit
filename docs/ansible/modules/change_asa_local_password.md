...
> MODULE [1mcisco.sccfm.change_asa_local_password[0m (sccfm-ansible/plugins/modules/change_asa_local_password.py)
...
[1mOPTIONS[0m (red indicates it is required):
   ...
   [1mnew_password[0m  The new password to set for the user.
        no_log: true
        type: str
   ...
   [1musername[0m  The local ASA username whose password will be changed.
        type: str
