...
> MODULE [1mcisco.sccfm.trigger_ftd_upgrade[0m (sccfm-ansible/plugins/modules/trigger_ftd_upgrade.py)
...
[1mOPTIONS[0m (red indicates it is required):
   ...
   [1msoftware_version[0m  Target FTD software version (e.g. `7.4.1').
