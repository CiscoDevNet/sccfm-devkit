...
> MODULE [1mcisco.sccfm.edit_object_override[0m (sccfm-ansible/plugins/modules/edit_object_override.py)
...
[1mOPTIONS[0m (red indicates it is required):
   ...
   [1moverride_value[0m  The new value for the override. For network objects
   ...
   [1mtarget_id[0m  UID of the target device whose override value to edit.
        type: str

   [1muid[0m     Unique identifier (UID) of the object to edit.
        type: str
