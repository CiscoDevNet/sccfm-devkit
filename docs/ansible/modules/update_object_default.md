...
> MODULE [1mcisco.sccfm.update_object_default[0m (sccfm-ansible/plugins/modules/update_object_default.py)
...
[1mOPTIONS[0m (red indicates it is required):
   ...
   [1muid[0m     Unique identifier (UID) of the object to update.
        type: str

   [1mvalue[0m   The new default value for the object. For network objects
