...
> MODULE [1mcisco.sccfm.change_asa_boot_image[0m (sccfm-ansible/plugins/modules/change_asa_boot_image.py)
...
[1mOPTIONS[0m (red indicates it is required):
   ...
   [1mimage_path[0m  Full ASA image path already present on the device, such
