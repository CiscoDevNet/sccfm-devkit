...
> MODULE [1mcisco.sccfm.list_asa_not_on_version[0m (sccfm-ansible/plugins/modules/list_asa_not_on_version.py)
...
[1mOPTIONS[0m (red indicates it is required):
   ...
   [1mversion[0m  The target software version to check against (e.g.
            `9.20(3'13)).
